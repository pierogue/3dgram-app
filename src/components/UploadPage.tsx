import { Button, FileInput, Input, Select, Spinner, Textarea, Image } from "@telegram-apps/telegram-ui"
import { useEffect, useState } from "react"
import styled from "styled-components"
import { categoryLightDto } from "../dto/categoryDto"
import axios from "axios";
import struc from "../assets/archive_structure.png";
...
export const UploadPage = () => {
  ...
  const handleUpload = async ()=>{
    ...
    const response = await axios.postForm(`${apiUrl}/models`,{
      title: title,
